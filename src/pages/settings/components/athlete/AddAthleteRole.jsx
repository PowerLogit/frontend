    ...
    return (
        <form className='p-5' onSubmit={onHandleSubmit}>
            <p className='mb-2 text-gray-500 dark:text-gray-300'>
                Al hacer clic en el botón &quot;Convertirse en Atleta&quot;,
                aceptas asumir las responsabilidades y compromisos asociados con
                ser un atleta en nuestra plataforma.
            </p>
            <p className='mb-6 text-gray-500 dark:text-gray-300'>
                Estamos emocionados de tener nuevos atletas como tú en nuestra
                comunidad y esperamos que aproveches al máximo esta oportunidad
                de compartir tu pasión por el powerlifting.
            </p>
...
const handleSubmit = async (ev, setIsSubmitting, closeModal, dispatchAuth) => {
    ...
    if (status === 200) {
        ...
        closeModal()
        toast.success(
            '¡Adelante y comienza tu carrera como atleta en PowerLog!'
        )
    } else {
        toast.error(
            'Ha ocurrido un error al convertirse en atleta. Por favor, inténtalo de nuevo'
        )
    }
